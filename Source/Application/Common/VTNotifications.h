...
// Request addition of a new desktop
#define VTRequestAddDesktopName					@"VTRequestAddDesktop"
...
#pragma mark -
#pragma mark Generic application status events

#define kVTOnApplicationStartedUp				@"VTApplicationStartedUp"
#define kVTApplicationStartedUp					@"VTApplicationStartedUp"
